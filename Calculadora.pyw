...
boton_raiz_cuadrada=  Button(ventana, text= "√", width= 5, height= 2, command = lambda: click_boton("√"))
...
boton_raiz_cuadrada.grid(row =5, column =3, padx =5, pady=5)
boton_igual.grid(row = 6, column = 0, columnspan=4, sticky=(W,E))
